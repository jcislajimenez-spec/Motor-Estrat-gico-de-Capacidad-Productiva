                                    ...
                                    if st.button(
                                        ...
                                        if _prb_load_base is None or (
                                            ...
                                            if _prb_ampliar and _prb_mover:
                                                ...
                                                if len(_prb_mover) > 1:
                                                    st.warning(
                                                        "Solo se permite mover un proyecto "
                                                        "por vez. Desmarca los proyectos "
                                                        "extra: "
                                                        + ", ".join(_prb_mover) + "."
                                                    )
                                                elif len(_prb_mover) == 1:
                                                    _prb_proj = _prb_mover[0]
                                                    _prb_san_m = "".join(
                                                    ...
                                                    if not _prb_dest_sel:
                                                        ...
                                                        # Validar que cada destino tiene
                                                        # candidata + cap válida antes de operar
                                                        _prb_cands_m = (
                                                        ...
                                                        if _prb_cap_ok:
                                                            ...
                                                            if not _prb_lins_m:
                                                                ...
                                                                # Guard: cualquier "Mover
                                                                # línea 2ª ronda" para
                                                                # este proyecto bloquea
                                                                if any(
                                                                    str(
                                                                        m.get(
                                                                            "tipo_accion",
                    ...
                    if _comb_apply_clicked:
                        ...
                        if not _ml_has_sel and not _as_has_sel:
                            ...
                            if _comb_proyectos_dup:
                                st.warning(
                                    "No se permite combinar mover línea y ampliar semanas sobre "
                                    "el mismo proyecto en esta fase. "
