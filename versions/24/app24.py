            ...
            with right:
                ...
                for m, pct, col in segments:
                    ...
                    fig.add_trace(go.Bar(
                        ...
                        name=m,
                        marker_color=col,
                        hovertemplate=f"{m}<br>%{{y:.2f}}%<extra></extra>",
                    ))
                ...
                if exceso > 0:
                    fig.add_trace(go.Bar(
                        ...
                        name="Exceso",
                        marker_color="red",
                        hovertemplate="Exceso<br>%{y:.2f}%<extra></extra>",
                    ))
                ...
                fig.update_yaxes(range=[0, max(120, total_selected_pct + 5)], title="% de techo estructural", ticksuffix="%")
